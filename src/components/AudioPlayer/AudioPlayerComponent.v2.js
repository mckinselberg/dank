...
export default function AudioPlayerComponent() {
  ...
  return (
    <>
      ...
      {refAudioElement.current.addEventListener('loadedmetadata', () => {
        setSongDuration(refAudioElement.current.duration);
      })}

      {refAudioElement.current.addEventListener('timeupdate', () => {
        //setSongCurrentTime(refAudioElement.current.currentTime);
      })}

      {refAudioElement.current.addEventListener('ended', (e) => {
